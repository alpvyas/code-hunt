...
module.exports = {
  up: (queryInterface, Sequelize) => {
      return queryInterface.bulkInsert('Users', [{
        ...
        hashedPassword: "$2y$08$yRvoJ0WKbw9doOqFAd3YcuSvb2TBbsXTrII/VGNUbnSVvB.eS7W.K",
      ...
      },
      {
        ...
        hashedPassword: "$2y$08$yRvoJ0WKbw9doOqFAd3YcuSvb2TBbsXTrII/VGNUbnSVvB.eS7W.K",
        bio: "Computer scientist, mathematician and logician who created the Turing machine.",
      ...
      },
      {
        ...
        hashedPassword: "$2y$08$yRvoJ0WKbw9doOqFAd3YcuSvb2TBbsXTrII/VGNUbnSVvB.eS7W.K",
        bio: "Designed, developed and constructed India's first indigenous computer in ISI in 1953.",
        username: "samkumitra",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
